...
Provides dotnet bindings and dotnet based tooling for Morphir.
...
GitHub Actions |
:---: |
[![GitHub Actions](https://github.com/finos/morphir-dotnet/workflows/Build%20main/badge.svg)](https://github.com/finos/morphir-dotnet/actions?query=branch%3Amain) |
[![Build History](https://buildstats.info/github/chart/finos/morphir-dotnet)](https://github.com/finos/morphir-dotnet/actions?query=branch%3Amain) |
...
- `AssemblyInfo` - Generates [AssemblyInfo](https://docs.microsoft.com/en-us/dotnet/api/microsoft.visualbasic.applicationservices.assemblyinfo?view=netframework-4.8) for libraries.
