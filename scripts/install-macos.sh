...
# Morphir CLI Standalone Executable Installation Script for macOS
# 
...
#
# Usage: 
#   ./install-macos.sh [OPTIONS] [VERSION]
#   ./install-macos.sh list-versions [--preview]
#
# Options:
...
#
# Examples:
#   ./install-macos.sh                           # Install latest stable from NuGet
#   ./install-macos.sh 0.3.0                     # Install specific version
#   ./install-macos.sh --preview                 # Install latest preview
#   ./install-macos.sh --source github           # Use GitHub releases
#   ./install-macos.sh list-versions             # List available versions
#   ./install-macos.sh list-versions --preview   # List all versions including preview
