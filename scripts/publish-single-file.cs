...
// Usage: dotnet run scripts/publish-single-file.cs [RID] [CONFIGURATION] [VERSION] [OUTPUT_DIR]
...
var outputDir = scriptArgs.Length > 3 ? scriptArgs[3] : "./artifacts/single-file";
...
Console.WriteLine($"Publishing single-file executable (managed, trimmed) for {rid}...");
