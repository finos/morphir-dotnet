...
# Usage: ./scripts/publish-single-file.sh [RID] [CONFIGURATION] [VERSION] [OUTPUT_DIR]
#   RID: Runtime identifier (e.g., linux-arm64, win-x64)
#   CONFIGURATION: Build configuration (default: Release)
#   VERSION: Package version (optional)
#   OUTPUT_DIR: Output directory (default: ./artifacts/single-file)
...
CONFIG="${2:-Release}"
VERSION="${3:-}"
OUTPUT_DIR="${4:-./artifacts/single-file}"
...
echo "Publishing single-file executable (managed, trimmed) for $RID..."
