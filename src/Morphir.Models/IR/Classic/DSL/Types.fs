...
module Types =
    ...
    type TypeBuilder<'attributes>() =
        ...
        /// </summary>
        member _.func(paramTypes: Type<'attributes> list, returnType: Type<'attributes>) =
        ...
        /// </summary>
        member _.field(name: Name, typ: Type<'attributes>) = Type.field name typ
    ...
    type TypeBuilder() =
        ...
        /// Creates an ExtensibleRecord type (record that can be extended).
        /// </summary>
        member _.extensibleRecord(variableName: Name, fields: Field<unit> list) =
            Type.ExtensibleRecord(defaultAttrs, variableName, fields)

        /// <summary>
        /// Creates an ExtensibleRecord type with variable name from string.
        /// </summary>
        member _.extensibleRecord(variableName: string, fields: Field<unit> list) =
            Type.ExtensibleRecord(defaultAttrs, Name.fromString variableName, fields)

        /// <summary>
        /// Creates a Function type (arg -> return).
        /// </summary>
        member _.functionType(argType: Type<unit>, returnType: Type<unit>) =
            Type.Function(defaultAttrs, argType, returnType)
        ...
        /// Chains parameters correctly: func [Int; Char] String = Int -> Char -> String
        /// </summary>
        member _.func(paramTypes: Type<unit> list, returnType: Type<unit>) =
            List.foldBack (fun param acc -> Type.Function(defaultAttrs, param, acc)) paramTypes returnType
        ...
        /// Creates a Field for use in Record types.
        /// </summary>
        member _.field(name: Name, typ: Type<unit>) = Type.field name typ
        ...
        member _.ReferenceOp(_state: Type<unit>, fqName: FQName) =
        ...
        /// </summary>
        [<CustomOperation("reference")>]
        member _.ReferenceOp(_state: Type<unit>, fqName: FQName, typeArgs: Type<unit> list) =
            Type.Reference(defaultAttrs, fqName, typeArgs)
        ...
        member _.TupleOp(_state: Type<unit>, elementTypes: Type<unit> list) =
            Type.Tuple(defaultAttrs, elementTypes)
        ...
        member _.RecordOp(_state: Type<unit>, fields: Field<unit> list) =
            Type.Record(defaultAttrs, fields)
        ...
        member _.VariableOp(_state: Type<unit>, name: string) =
        ...
        /// </summary>
        [<CustomOperation("variable")>]
        member _.VariableOp(_state: Type<unit>, name: Name) =
        ...
        member _.FieldOp(_state: Type<unit>, name: string, typ: Type<unit>) =
            Type.field (Name.fromString name) typ
        ...
        member _.FunctionTypeOp(_state: Type<unit>, argType: Type<unit>, returnType: Type<unit>) =
            Type.Function(defaultAttrs, argType, returnType)
        ...
        member _.FuncOp(_state: Type<unit>, paramTypes: Type<unit> list, returnType: Type<unit>) =
            List.foldBack (fun param acc -> Type.Function(defaultAttrs, param, acc)) paramTypes returnType
