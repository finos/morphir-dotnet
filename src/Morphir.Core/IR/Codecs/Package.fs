        ...
        |> Encode.list (fun (moduleName, moduleDef) ->
            Encode.list id [
                ...
                AccessControlled.encoder
                    (Module.encodeDefinition encodeTypeAttributes encodeValueAttributes)
                    moduleDef
            ]
        )
    ]
                    ...
                    Decode.map2
                        ...
                        (Decode.index
                            ...
                            (AccessControlled.decoder (
                                Module.decodeDefinition decodeTypeAttributes decodeValueAttributes
                            )))
                ))))
