...
let decoder:Decode.Decoder<Literal> =
    ...
    |> Decode.andThen (function
        | "BoolLiteral" ->
            Decode.map boolLiteral (Decode.index 1 Decode.bool)
        | "CharLiteral" ->
        ...
        | "StringLiteral" ->
            Decode.map stringLiteral (Decode.index 1 Decode.string)
        | "WholeNumberLiteral" ->
            Decode.map wholeNumberLiteral (Decode.index 1 Decode.int64)
        | "FloatLiteral" ->
            Decode.map floatLiteral (Decode.index 1 Decode.float)
        | "DecimalLiteral" ->
