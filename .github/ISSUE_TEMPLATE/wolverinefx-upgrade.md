---
name: Upgrade WolverineFx to 5.9.0
about: Fast-follow issue to upgrade WolverineFx back to 5.9.0 and fix E2E test log filtering
title: 'Upgrade WolverineFx to 5.9.0 and Update E2E Test Log Filtering'
labels: ['technical-debt', 'bug', 'priority:high', 'epic:deployment-architecture']
assignees: ''
---
