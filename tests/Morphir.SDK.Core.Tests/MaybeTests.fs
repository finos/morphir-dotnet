        ...
        [ describe
              ...
              [ describe
                    ...
                    [
                      ...
                      testCase "default used" <| fun _ -> Expect.equal 5 (Maybe.withDefault 5 Nothing) ]

                describe
                    "map Tests"
                    [ let f n = n + 1

                      testCase "on Just" <| fun _ -> Expect.equal (Just 1) (Maybe.map f (Just 0))

                      testCase "on Nothing" <| fun _ -> Expect.equal (Just 1) (Maybe.map f (Just 0))
